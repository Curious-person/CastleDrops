              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    errors.password && "border-rose-300 focus-visible:border-rose-500 focus-visible:ring-rose-500/20"
                  )}
                />
                <button
                  type="button"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "pl-9 pr-10 h-10 border-gray-200 focus-visible:border-[#2FA9D9] focus-visible:ring-[#2FA9D9]/20",
                    errors.confirmPassword && "border-rose-300 focus-visible:border-rose-500 focus-visible:ring-rose-500/20"
                  )}
                />
                <button
                  type="button"
